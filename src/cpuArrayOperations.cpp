...
template void cpuKron(double*, double*, double*, double, int, int);
template void cpuKron(float*, float*, float*, float, int, int);

template void cpuKron(double*, double*, double*, int, int, int, int);
template void cpuKron(float*, float*, float*, int, int, int, int);

template double cpuArrayNorm(double*, int);
template float cpuArrayNorm(float*, int);
