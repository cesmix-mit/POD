...
// compute POD descriptors and derivatives 
#include "poddescriptors.cpp"

// compute SNAP descriptors and derivatives 
#include "podsnap.cpp"

// compute energy and force after fitting POD potentials with podfit.cpp
#include "podenergyforce.cpp"

// constructor 
CPOD::CPOD(std::string pod_file, std::string coeff_file)
{
...
// }
// 
// // void CPOD::linear_descriptors(double *gd, double *efatom, double *rij, double *tmpmem, int *pairnumsum,
// //         int *atomtype, int *ai, int *aj, int *ti, int *tj, int natom, int Nij)
// // {
// //     int dim = 3;    
// //     int nelements = pod.nelements;
// //     int nbesselpars = pod.nbesselpars;
...
// //     // peratom descriptors for one-body, two-body, and three-body linear potentials
// //     this->poddesc(eatom1, fatom1, eatom2, fatom2, eatom3, fatom3, rij, Phi2, besselparams, 
// //             tmpmem, rin, rcut, pairnumsum, atomtype, ai, aj, ti, tj, elemindex, pdegree2, 
// //             nbesselpars, nrbf2, nrbf3, nabf3, nelements, Nij, natom);                    
// //     
// //     if (pod.snaptwojmax>0) 
// //         this->snapdesc(eatom4, fatom4, rij, tmpmem, atomtype, ai, aj, ti, tj, natom, Nij);            
// //     
// //     // global descriptors for one-body, two-body, three-body, and four-bodt linear potentials    
// //     podArraySetValue(tmpmem, 1.0, natom);
// //     
...
// }
// 
// // double CPOD::energyforce_calculation(double *force, double *gd, double *gdd, double *coeff, double *rij, 
// //         double *tmpmem, int *pairnumsum, int *atomtype, int *ai, int *aj, int *ti, int *tj, int natom, int Nij)         
// // {
// //     int dim = 3;
// //     int nd1234 = pod.nd1+pod.nd2+pod.nd3+pod.nd4;        
// //     
// //     // calculate POD and SNAP descriptors and their derivatives
// //     this->linear_descriptors(gd, gdd, rij, tmpmem, pairnumsum, atomtype, ai, 
// //             aj, ti, tj, natom, Nij);                
// //         
// //     // calculate energy and force
// //     double energy = 0.0;
...
// }
// 
// // void CPOD::pod2body(double *eatom, double *fatom, double *y, double *Phi, double *besselparams, double *tmpmem, 
...
// // }
// 
// // void CPOD::pod3body(double *eatom, double *fatom, double *x, double *e2ij, double *f2ij, double *tmpmem, 
...
// //     this->pod3body(eatom3, fatom3, y, e2ij, f2ij, &tmpmem[3*Nij+4*Nij*nrbf], elemindex, pairlist, pairnum, pairnumsum, 
