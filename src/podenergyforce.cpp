...
double CPOD::calculate_energy(double *forcecoeff, double *gd, double *coeff)
{        
    int nd1 = pod.nd1;
    int nd2 = pod.nd2;
    int nd3 = pod.nd3;
    ...
    for (int i=0; i< nd1234; i++) forcecoeff[i] += coeff[i];    
...
void CPOD::calculate_force(double *force, double *forcecoeff, double *rij, double *tmpmem, int *pairnumsum,
...
double CPOD::energyforce_calculation(double *force, double *podcoeff, double *forcecoeff, double *gd, double *rij, 
...
{       
    ...
    double energy = this->calculate_energy(forcecoeff, gd, podcoeff);    
        
    podArraySetValue(force, 0.0, 3*natom);    

    this->calculate_force(force, forcecoeff, rij, tmpmem, pairnumsum, atomtype, idxi, ai, aj, ti, tj, natom, Nij);
