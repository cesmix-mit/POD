...
// void CPOD::snapdesc(double *blist, double *bd, double *y, double *tmpmem, int *atomtype, 
//         int *alist, int *pairlist, int *pairnumsum, int *tmpint, int natom, int Nij)            
// {    
//     int dim = 3;    
//     //int idxcg_max = sna.idxcg_max;
//     int idxu_max = sna.idxu_max;
...
//           idxcg_block, twojmax, idxu_max, idxz_max, nelem, bnormflag, natom);
// 
//     snapComputeBi2(blist, Zr, Zi, Utotr, Utoti, bzero, alist, atomtype, 
